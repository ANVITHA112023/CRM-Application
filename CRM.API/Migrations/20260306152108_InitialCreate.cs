        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Tasks_SalesReps_SalesRepId",
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, new DateTime(2026, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), "admin@crm.com", "Admin", "$2a$11$Ql5OsyBnAuQMCREoMKMHYuBpCgvTTNFMdMJlPAQWFRFOZmCRGgR5e", "Admin" });

            migrationBuilder.CreateIndex(
                name: "IX_Tasks_SalesRepId",
                table: "Tasks",
                column: "SalesRepId");
        }
